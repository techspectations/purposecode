...
import com.purposecodes.hackathon.App;
import com.purposecodes.hackathon.ListingActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    void updateMetricScore(MetricDisplay metricDisplay, Face face) {
        ...
        if (score > 50) {
            Log.e(LOG_TAG, "Emotion " + metric + ", Score " + score);

            stopDetector();

            // Calling search api
            Intent intent = new Intent(this, ListingActivity.class);
            intent.putExtra("term", metric.toString());
